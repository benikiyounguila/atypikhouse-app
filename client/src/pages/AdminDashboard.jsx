        ...
        <nav className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <svg 
              ...
              className="h-12 w-12 mx-auto text-gray-700 mb-4"
            >
              <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.5V15m0 0l-3-3m3 3l3-3m-4.5-9H9.75a2.25 2.25 0 00-2.25 2.25v10.5a2.25 2.25 0 002.25 2.25h7.5a2.25 2.25 0 002.25-2.25V6.75a2.25 2.25 0 00-2.25-2.25z" />
            </svg>
            Gérer les demandes propriétaires
          </Link>
        </nav>
      </div>
    </div>
