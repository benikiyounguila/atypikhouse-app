    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            if (response && response.success) {
                ...
                console.error('[LOGIN PAGE] Login failed:', response?.message);
                toast.error(response ? response.message : "Erreur de connexion");
            }
        } catch (error) {
            ...
            <div className="mb-40">
                ...
                <form className="mx-auto max-w-md" onSubmit={handleFormSubmit}>
                    ...
                    <input
                        ...
                        disabled={loading} // Désactiver pendant le chargement
                    />
                    <button className="primary my-4" disabled={loading}> {/* Désactiver le bouton pendant le chargement */}
