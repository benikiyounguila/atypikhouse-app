...
const PhotosUploader = ({ addedPhotos, setAddedPhotos, setIsUploading }) => {
  ...
  return (
    <>
      ...
      <div className="mt-2 grid grid-cols-3 gap-2 md:grid-cols-4 lg:grid-cols-6 ">
        {console.log('[PHOTOS UPLOADER] Rendering photos:', addedPhotos)}
        ...
        <label className="flex items-center justify-center w-full h-32 px-4 py-2 text-base font-medium text-white bg-green-600 border border-transparent rounded-md shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 cursor-pointer">
          <input
            type="file"
            multiple
            className="hidden"
