...
router.put("/owners/:id/approve", isAdmin, adminController.approveOwner);
router.put("/owners/:id/reject", isAdmin, adminController.rejectOwner);
router.get("/owners/pending", isAdmin, adminController.getPendingOwners);
router.get("/owners/:id/places", isAdmin, adminController.getPlacesByOwner);
